...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-10 col-sm-10 col-10 offset-md-1 offset-sm-10 breadcumb">
            <p  class= "text-right">Home/Item/Add Item</p>
        </div>
           ...
           @csrf
               <div class="row">
                   ...
                   <div class="col-md-9 p-0 m-0">
                    <input type="text" class="form-control" name="item_id" id="fullname" placeholder="Item Id">
                    <input type="text" class="form-control" name="name" id="username" placeholder="Item Name">
