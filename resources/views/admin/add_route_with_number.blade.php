...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-10 col-sm-10 col-10 offset-md-1 offset-sm-1 main_page_new_order">
           ...
           <form action="{{route('add-route-with-number')}}" method="post">
           @csrf
               <div class="row">
                   ...
                   <div class="col-md-9 p-0 m-0">
                    <input type="text" class="form-control" name="mobile_number" id="fullname" placeholder="88018">
                    <input type="text" class="form-control" name="route_name" id="username" placeholder="Route Name">
                    <input type="text" class="form-control" name="short_name" id="username" placeholder="Short Name">
