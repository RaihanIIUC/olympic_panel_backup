...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-10 col-sm-10 col-10 offset-md-1 offset-sm-10 breadcumb">
            <p  class= "text-right">Home/Item/Edit Item</p>
        </div>
           ...
           @csrf
               <div class="row">
                   <div class="col-md-3 p-0 m-0">
                    <label for="fullname" class="">Item Id</label>
                    <label for="username" class="">Item Name</label>
                   
                   </div>
                   <div class="col-md-9 p-0 m-0">
                    <input type="text" class="form-control" name="item_id" id="fullname" placeholder="Full Name" value="{{$data->item_id}}">
                    <input type="text" class="form-control" name="name" id="username" placeholder="Username"value="{{$data->name}}" >
