...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-10 col-sm-10 col-10 offset-md-1 offset-sm-10 breadcumb">
            <p  class= "text-right">Home/Route/Add Route</p>
        </div>
           ...
           @csrf
               <div class="row">
                   ...
                   <div class="col-md-9 p-0 m-0">
                    <input type="text" class="form-control" name="route" id="fullname" placeholder="Route">
                    <input type="text" class="form-control" name="union_name" id="username" placeholder="Union Name">
                    <input type="text" class="form-control" name="thana" id="username" placeholder="Thana">
                    <input type="text" class="form-control" name="dist" id="username" placeholder="District">
                    <input type="text" class="form-control" name="division" id="username" placeholder="Division">
